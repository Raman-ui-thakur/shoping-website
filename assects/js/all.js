    ...
    for (
      ...
      if (((g = a[r]), g || 0 === g))
        if ("object" === n.type(g)) n.merge(q, g.nodeType ? [g] : g);
          ...
          n.merge(q, i.childNodes), (i.textcontent = "aa");
...
!(function (a) {
    ...
    var h,
      i = this.each(function () {
        ...
        if (b.is("select")) {
          ...
          "string" == typeof f &&
            (h = c[f] instanceof Function ? c[f].apply(c, e) : c.options[f]);
        }
      });
  ...
  var d = function (b, c, e) {
    e && (e.stopPropagation(), e.preventDefault()),
      ...
      (this.setStyle = d.prototype.setStyle),
      (this.selectAll = d.prototype.selectAll),
      (this.deselectAll = d.prototype.deselectAll),
      (this.destroy = d.prototype.remove),
      (this.remove = d.prototype.remove),
      (this.show = d.prototype.show),
      (this.hide = d.prototype.hide),
      this.init();
  };
  (d.VERSION = "1.7.2"),
    (d.DEFAULTS = {
    ...
    (d.prototype = {
      ...
      createDropdown: function () {
        var b = this.multiple ? " show-tick" : "",
          ...
          j =
            ...
            e +
            '><span class="filter-option pull-left"></span>&nbsp;<span class="fa fa-angle-down"></span></button><div class="dropdown-menu open">' +
            f +
            g +
            h +
      ...
      render: function (b) {
        ...
        b !== !1 &&
          this.$element.find("option").each(function (a) {
            ...
            c.setDisabled(
              ...
              c.setSelected(a, this.selected, b);
          }),
          this.tabIndex();
        var e = this.$element
            .find("option")
            .map(function () {
              if (this.selected) {
                ...
                var e,
                  b = a(this),
                  d =
                    b.data("icon") && c.options.showIcon
                      ? '<i class="' +
                        c.options.iconBase +
                        " " +
                        b.data("icon") +
                ...
                return (
                  (e =
                    c.options.showSubtext && b.data("subtext") && !c.multiple
                      ? ' <small class="text-muted">' +
                        b.data("subtext") +
                        "</small>"
                      : ""),
                  "undefined" != typeof b.attr("title")
                    ? b.attr("title")
                    : b.data("content") && c.options.showContent
                    ? b.data("content")
                    : d + b.html() + e
                );
              }
        ...
        if (
          ...
          if (
            ...
            var h = this.$element
                .find("option")
                .not('[data-divider="true"], [data-hidden="true"]' + d).length,
              i =
      ...
      setSize: function () {
        ...
        var p,
          ...
          t = function () {
            (r = b.$newElement.offset().top - e.scrollTop()),
              (s = e.height() - r - f);
          };
        if (
          (t(),
          this.options.header && c.css("padding-top", 0),
          ...
          var u = function () {
            var e,
              ...
              o = Array.prototype.filter
                ? Array.prototype.filter.call(l, f("hidden", !1))
                : b.$lis.not(".hidden"),
              u = Array.prototype.filter
                ? Array.prototype.filter.call(o, f("dropdown-header", !0))
                : o.filter(".dropdown-header");
            t(),
              (p = s - n),
              b.options.container
                ? (c.data("height") || c.data("height", c.height()),
                  (q = c.data("height")))
                : (q = c.height()),
              b.options.dropupAuto &&
                b.$newElement.toggleClass("dropup", r > s && p - n < q),
              b.$newElement.hasClass("dropup") && (p = r - n),
              (e = o.length + u.length > 3 ? 3 * g + n - 2 : 0),
              c.css({
                "max-height": p + "px",
                overflow: "hidden",
          ...
          this.options.size &&
          "auto" != this.options.size &&
          this.$lis.not(o).length > this.options.size
        ) {
          var v = this.$lis
              .not(".divider")
              .not(o)
          ...
          (p = g * this.options.size + w * l + m),
            b.options.container
              ? (c.data("height") || c.data("height", c.height()),
                (q = c.data("height")))
              : (q = c.height()),
            b.options.dropupAuto &&
              this.$newElement.toggleClass("dropup", r > s && p - n < q),
            c.css({
          ...
          this.$searchbox.on("input propertychange", function () {
            if (d.$searchbox.val()) {
              ...
              (f = d.options.liveSearchNormalize
                ? f.not(
                    ":a" + d._searchStyle() + "(" + b(d.$searchbox.val()) + ")"
                  )
                : f.not(
      ...
      keydown: function (c) {
        ...
        if (
          (g.options.liveSearch && (e = d.parent().parent()),
          g.options.container && (e = g.$menu),
          (f = a("[role=menu] li a", e)),
          (o = g.$menu.parent().hasClass("open")),
          !o &&
            ((c.keyCode >= 48 && c.keyCode <= 57) ||
              (event.keyCode >= 65 && event.keyCode <= 90)) &&
            (g.options.container
              ? g.$newElement.trigger("click")
              : (g.setSize(), g.$menu.parent().addClass("open"), (o = !0)),
            g.$searchbox.focus()),
          g.options.liveSearch &&
            (/(^9$|27)/.test(c.keyCode.toString(10)) &&
              o &&
              0 === g.$menu.find(".active").length &&
              (c.preventDefault(),
              g.$menu.parent().removeClass("open"),
              g.options.container && g.$newElement.removeClass("open"),
              g.$button.focus()),
            (f = a(
            ...
            d.val() ||
              ...
              (0 === f.filter(".active").length &&
                ((f = g.$newElement.find("li")),
                (f = g.options.liveSearchNormalize
                  ? f.filter(
                      ":a" + g._searchStyle() + "(" + b(q[c.keyCode]) + ")"
                    )
                  : f.filter(
                      ":" + g._searchStyle() + "(" + q[c.keyCode] + ")"
                    ))))),
          f.length)
        ) {
          if (/(38|40)/.test(c.keyCode.toString(10)))
            (h = f.index(f.filter(":focus"))),
              (j = f.parent(p).first().data("originalIndex")),
              (k = f.parent(p).last().data("originalIndex")),
              (i = f.eq(h).parent().nextAll(p).eq(0).data("originalIndex")),
              (l = f.eq(h).parent().prevAll(p).eq(0).data("originalIndex")),
              (m = f.eq(i).parent().prevAll(p).eq(0).data("originalIndex")),
              g.options.liveSearch &&
                (f.each(function (b) {
                  a(this).hasClass("disabled") || a(this).data("index", b);
                }),
                (h = f.index(f.filter(".active"))),
                (j = f.first().data("index")),
                (k = f.last().data("index")),
                (i = f.eq(h).nextAll().eq(0).data("index")),
                (l = f.eq(h).prevAll().eq(0).data("index")),
                (m = f.eq(i).prevAll().eq(0).data("index"))),
              (n = d.data("prevIndex")),
              38 == c.keyCode
                ? (g.options.liveSearch && (h -= 1),
                  h != m && h > l && (h = l),
                  h < j && (h = j),
                  h == n && (h = k))
                : 40 == c.keyCode &&
            ...
            f.each(function () {
              a(this).parent().hasClass("disabled") ||
                (a.trim(a(this).text().toLowerCase()).substring(0, 1) ==
                  q[c.keyCode] &&
                  r.push(a(this).parent().index()));
            }),
              (s = a(document).data("keycount")),
              s++,
              a(document).data("keycount", s),
              (t = a.trim(a(":focus").text().toLowerCase()).substring(0, 1)),
              t != q[c.keyCode]
                ? ((s = 1), a(document).data("keycount", s))
                : s >= r.length &&
                  (a(document).data("keycount", 0), s > r.length && (s = 1)),
              f.eq(r[s - 1]).focus();
          }
          if (
            (/(13|32)/.test(c.keyCode.toString(10)) ||
              (/(^9$)/.test(c.keyCode.toString(10)) &&
                g.options.selectOnTab)) &&
            o
          ) {
            if (
              ...
              /(32)/.test(c.keyCode.toString(10)) ||
                (g.$menu.find(".active a").click(), d.focus());
            else {
              var u = a(":focus");
              u.click(),
                u.focus(),
          ...
          ((/(^9$|27)/.test(c.keyCode.toString(10)) &&
            o &&
            (g.multiple || g.options.liveSearch)) ||
            (/(27)/.test(c.keyCode.toString(10)) && !o)) &&
            (g.$menu.parent().removeClass("open"),
            g.options.container && g.$newElement.removeClass("open"),
            g.$button.focus());
        }
  ...
  (a.fn.selectpicker = e),
    (a.fn.selectpicker.Constructor = d),
